...
{
    options.SwaggerDoc("v1", new OpenApiInfo { Title = "Aima API", Version = "v1" });
...
//Web Application related configurations
{
    ...
    app.UseSwaggerUI(s =>
    {
        s.SwaggerEndpoint("/swagger/v1/swagger.json", "Aima API");
